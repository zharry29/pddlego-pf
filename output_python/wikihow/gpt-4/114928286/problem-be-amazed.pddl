Sure, here is the problem file for task "amaze":

```
(define (problem amaze)
(:domain throw-food)
(:objects
...
(:init
    ...
    (at table kitchen) (at hotdog1 living) (at hotdog2 living) (at hotdog3 living) (empty kitchen)
)
(:goal
    (and
...
Adjust objects, locations, and initial states according to your specific case.