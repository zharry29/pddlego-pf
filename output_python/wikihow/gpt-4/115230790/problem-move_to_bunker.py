...
```
This problem file handles the task "ve to bunker". The initial state is the survivor is at the location and the goal is for the survivor to be at the bunker.