Here is the PDDL domain file in python format:
...
class SecretSocietyDomain(Domain):
    ...
    def reveal_secret(self, f, se):
        ...
        return precond, effect
```
The PDDL predicates are member_of, has_secret, and knows to describe various relationships. The actions are create_society, add_secret, invite_member and reveal_secret.