(define (domain emergency-preparedness)
	...
	(:action prepare-for-attack
		...
		:precondition (and (radio-on ?r) (receive-information ?p ?r ?l) (if-mentioned-blast ?r) (stay-indoors ?p) (stay-in-place ?p) (stay-outdoors ?p) (safe-location ?p ?l) (consume ?f ?p) (family ?p ?p) (family ?p ?s) (stay-in-place ?p) (stay-outdoors ?p) (stay-outdoors ?p) (family ?p ?p) (stay-in-place ?p) (stay-in-place ?p)